...
func GetMatch(region string, matchID string) (md *MatchData, err error) {
...
func GetMatchHistory(region string, accountID string) (ms *MatchHistory, err error) {
...
func GetMatchTimeline(region string, matchID string) (mt *MatchTimeline, err error) {
